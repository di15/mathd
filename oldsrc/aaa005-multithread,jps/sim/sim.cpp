...
#elif 1
	DefineUnit(UNIT_ROBOSOLDIER, "models/battlecomp2011simp/battlecomp.ms3d", Vec3f(1,1,1)*182.0f/70.0f, Vec3f(0,0,0)*182.0f/70.0f, Vec3i(125, 300, 125), "Robot Soldier", 100, true, true, false, false, false, 6, true);
#else
...
#define BUILDING_OFFSHOREOILRIG	32
	...
	DefineBuildingType(BUILDING_APARTMENT, "Apartment Building", Vec2i(2,1), "models/apartment1/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/apartment_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_HOUSE, "House", Vec2i(1,1), "models/house/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/house_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_FARM, "Farm", Vec2i(1,1), "models/farm/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/farm_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_GASSTATION, "Gas Station", Vec2i(1,1), "models/gasstation/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/gasstation_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_BANK, "Bank", Vec2i(1,1), "models/bank/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/bank_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CARDEALERSHIP, "Car Dealership", Vec2i(1,1), "models/cardealership/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/cardealership_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CARFACTORY, "Car Factory", Vec2i(1,1), "models/carfactory/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/carfactory_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_MILITARYBASE, "Military Base", Vec2i(1,1), "models/milbase/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/milbase_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_TRUCKFACTORY, "Truck Factory", Vec2i(1,1), "models/truckfactory/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/truckfactory_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CONCGARBTRFAC, "Concrete, Garbage Truck Factory", Vec2i(1,1), "models/concgarbtrfac/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/concgarbtrfac_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_TANKERTRFAC, "Tanker Truck Factory", Vec2i(1,1), "models/tankertrfac/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/tankertrfac_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CURREXCENTER, "Currency Exchange Center", Vec2i(1,1), "models/currexcenter/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/currexcenter_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_COALMINE, "Coal Mine", Vec2i(1,1), "models/coalmine/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/coalmine_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_COAL);
	...
	DefineBuildingType(BUILDING_HARBOUR, "Harbour", Vec2i(1,1), "models/harbour/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/harbour_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_COASTAL, RES_NONE);
	...
	DefineBuildingType(BUILDING_LUMBERMILL, "Lumber Mill", Vec2i(1,1), "models/lumbermill/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/lumbermill_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_FOREQFACTORY, "Forestry Equipment Factory", Vec2i(1,1), "models/foreqfactory/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/foreqfactory_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CEMENTPLANT, "Cement Plant", Vec2i(1,1), "models/cemplant/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/cemplant_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_CHEMPLANT, "Chemical Plant", Vec2i(1,1), "models/chemplant/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/chemplant_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_COALPOW, "Coal-Fired Powerplant", Vec2i(1,1), "models/coalpow/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/coalpow_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_ELECPLANT, "Electronics Manufacturing Plant", Vec2i(1,1), "models/elecplant/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/elecplant_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	//DefineBuildingType(BUILDING_FACTORY, "Factory", Vec2i(1,1), "models/factory/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/factory_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND);
	
	DefineBuildingType(BUILDING_IRONMINE, "Iron Mine", Vec2i(1,1), "models/ironmine/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/ironmine_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_IRONORE);
	...
	DefineBuildingType(BUILDING_URANMINE, "Uranium Mine", Vec2i(1,1), "models/uranmine/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/uranmine_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_URANIUMORE);
	...
	DefineBuildingType(BUILDING_NUCPOW, "Nuclear Powerplant", Vec2i(1,1), "models/nucpow/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/nucpow_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_OILREFINERY, "Oil Refinery", Vec2i(1,1), "models/oilrefinery/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/oilrefinery_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_OILWELL, "Oil Well", Vec2i(1,1), "models/oilwell/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/oilwell_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_CRUDEOIL);
	...
	DefineBuildingType(BUILDING_RESEARCHFAC, "Research Facility", Vec2i(1,1), "models/researchfac/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/researchfac_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_SHOPMALL, "Shopping Mall", Vec2i(1,1), "models/shopmall/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/shopmall_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	BuildingConMat(BUILDING_SHOPMALL, RES_CEMENT, 5);
	BuildingConMat(BUILDING_SHOPMALL, RES_LABOUR, 10);
	BuildingConMat(BUILDING_SHOPMALL, RES_STEEL, 10);
	BuildingInput(BUILDING_SHOPMALL, RES_ENERGY, 5);
	BuildingInput(BUILDING_SHOPMALL, RES_FARMPRODUCTS, 5);
	BuildingInput(BUILDING_SHOPMALL, RES_WATER, 5);
	BuildingOutput(BUILDING_SHOPMALL, RES_FOOD, 5);
	
	DefineBuildingType(BUILDING_STEELMILL, "Steel Mill", Vec2i(1,1), "models/steelmill/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/steelmill_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_STONEQUARRY, "Stone Quarry", Vec2i(1,1), "models/stonequarry/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/stonequarry_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_STONE);
	...
	DefineBuildingType(BUILDING_URANENRICHPL, "Uranium Enrichment Plant", Vec2i(1,1), "models/uranenrichpl/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/uranenrichpl_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_WATERTOWER, "Water Tower", Vec2i(1,1), "models/watertower/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/watertower_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_LAND, RES_NONE);
	...
	DefineBuildingType(BUILDING_WATERPUMPSTN, "Water Pumping Station", Vec2i(1,1), "models/waterpumpstn/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/waterpumpstn_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_COASTAL, RES_NONE);
	...
	DefineBuildingType(BUILDING_OFFSHOREOILRIG, "Offshore Oil Rig", Vec2i(1,1), "models/offshoreoilrig/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), "models/offshoreoilrig_c/basebuilding.ms3d", Vec3f(100,200,100), Vec3f(0,0,0), FOUNDATION_SEA, RES_CRUDEOIL);
